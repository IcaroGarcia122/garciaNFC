...
export const FinancesView: React.FC<FinancesViewProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      {/* Modal In-App de Confirmação para Excluir Despesa */}
      {expenseToDelete && (
          ...
          <div className="w-full max-w-md bg-[#0A162B] border border-rose-500/40 rounded-2xl p-5 sm:p-6 shadow-2xl text-slate-100 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Esta despesa será removida do cálculo de lucro líquido.</p>
              </div>
            </div>

            <div className="p-3.5 bg-[#060D1A] rounded-xl border border-slate-800 text-xs space-y-1">
              <p className="font-semibold text-white truncate">{expenseToDelete.description || 'Despesa'}</p>
